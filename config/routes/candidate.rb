...
namespace :candidate_interface, path: '/candidate' do
  ...
  scope '/application' do
    ...
    get '/submit/:id' => 'unsubmitted_application_form#submit_show', as: :application_submit_show
    post '/submit/:id' => 'unsubmitted_application_form#submit', as: :application_submit
