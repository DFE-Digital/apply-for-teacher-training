namespace :provider_interface, path: '/provider' do
  ...
  namespace :reports do
    ...
    resources :providers, only: [], path: '' do
      ...
      resource :recruitment_performance_report, only: :show, path: 'recruitment-performance-report(/:recruitment_cycle_year)'
      resources :regional_report_filters, only: %i[new create], path: 'regional-report-filter(/:recruitment_cycle_year)'
    end
  end
