Rails.application.routes.draw do
  ...
  namespace :support_interface, path: '/support' do
    ...
    scope '/performance' do
      ...
      get '/data-directory/export/:data_export_id' => 'data_exports#view_export_information', as: :view_export_information
      get '/data-directory/export/:data_export_id/history' => 'data_exports#view_history', as: :view_history
