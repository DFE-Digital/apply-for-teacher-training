...
RSpec.describe 'GET /candidate-api/v1.2/candidates', type: :request do
  ...
  it 'does not allow access to the API from other data users' do
    ...
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.month.ago.iso8601)}", token: api_token
  ...
  it 'allows access to the API for Candidate users' do
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.month.ago.iso8601)}", token: candidate_api_token
  ...
  it 'returns an error if the `updated_since` parameter is missing' do
    get_api_request '/candidate-api/v1.2/candidates', token: candidate_api_token
  ...
  it 'returns applications filtered with `updated_since`' do
    ...
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.day.ago.iso8601)}", token: candidate_api_token
  ...
  it 'does not return candidates without application forms which signed up during the previous recruitment_cycle' do
    ...
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(2.years.ago.iso8601)}", token: candidate_api_token
  ...
  it 'returns the correct page and the default page items' do
    ...
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.day.ago.iso8601)}&page=1", token: candidate_api_token
  ...
  it 'navigates through the pages' do
    ...
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.day.ago.iso8601)}&page=1&per_page=2", token: candidate_api_token

    expect(response).to have_http_status(:ok)
    expect(response.headers['current-page']).to eq '1'

    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.day.ago.iso8601)}&page=2&per_page=2", token: candidate_api_token
  ...
  it 'returns the correct page items from the per_page parameter' do
    ...
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.day.ago.iso8601)}&per_page=20", token: candidate_api_token
  ...
  it 'returns HTTP status 422 when given a parseable page value that exceeds the range' do
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.day.ago.iso8601)}&page=2", token: candidate_api_token
  ...
  it 'returns HTTP status 422 when given a parseable per_page value that exceeds the max value' do
    ...
    get_api_request "/candidate-api/v1.2/candidates?updated_since=#{CGI.escape(1.day.ago.iso8601)}&page=2&per_page=#{max_value + 1}", token: candidate_api_token
