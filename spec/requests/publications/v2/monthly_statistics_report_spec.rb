  ...
  describe 'publications/monthly-statistics/ITT(:year) when year is >= 2024' do
    ...
    context 'when monthly statistics redirect is disabled' do
      ...
      it 'renders the latest report for current time' do
        ...
        expect(response.body).to include('This report contains data collected during the 2023 to 2024 recruitment cycle for application in the academic year starting in September 2024.')
      end
