...
RSpec.describe ProviderInterface::ProviderUsersController, type: :request do
  ...
  describe 'validation errors' do
    ...
    it 'tracks validation errors for GET to edit_permissions' do
      allow_any_instance_of(ProviderInterface::ProviderUserEditPermissionsForm).to receive(:invalid?).and_return(true)
    ...
    it 'tracks validation errors for PATCH to update_permissions' do
      allow_any_instance_of(ProviderInterface::ProviderUserEditPermissionsForm).to receive(:save).and_return(false)
      expect {
