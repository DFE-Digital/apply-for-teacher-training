class ProviderInterface::FindCandidates::CandidateInvitedBannerComponentPreview < ViewComponent::Preview
  def candidate_invited_but_not_applied_yet_view
    ...
    render ProviderInterface::FindCandidates::CandidateInvitedBannerComponent.new(
      application_form:,
