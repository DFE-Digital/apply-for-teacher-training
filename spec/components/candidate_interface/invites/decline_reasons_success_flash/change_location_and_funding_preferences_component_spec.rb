...
RSpec.describe CandidateInterface::Invites::DeclineReasonsSuccessFlash::ChangeLocationAndFundingPreferencesComponent do
  ...
  context 'when the candidate has opted in and has set a funding type' do
    it 'renders with the change location preferences and funding message' do
      ...
      expect(result).to have_text('Change your location and funding preferences to receive invitations to more relevant courses')
      expect(result).to have_link('Change your location and funding preferences', href: component.candidate_interface_candidate_preferences_review_path)
