...
RSpec.describe CandidateInterface::LinksToPreviousApplicationsComponent do
  ...
  let!(:previous_application_form) { create(:completed_application_form, candidate:, phase: :apply_2, submitted_at: 3.days.ago) }
  let!(:first_application_form) { create(:completed_application_form, candidate:, phase: :apply_1, submitted_at: 5.days.ago) }
