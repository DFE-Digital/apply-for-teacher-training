...
RSpec.describe CandidateInterface::GcseRequirementsComponent, type: :component do
  ...
  let(:course_option) { create(:course_option, course: create(:course, :open, accept_pending_gcse: true, accept_gcse_equivalency: true, accept_english_gcse_equivalency: true)) }
