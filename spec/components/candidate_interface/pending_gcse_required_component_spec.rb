...
RSpec.describe CandidateInterface::PendingGcseRequiredComponent, type: :component do
  ...
  let(:course_option1) { create(:course_option, course: create(:course, :open, accept_pending_gcse: true)) }
  let(:course_option2) { create(:course_option, course: create(:course, :open, accept_pending_gcse: false)) }
