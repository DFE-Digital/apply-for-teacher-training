...
RSpec.describe CandidateInterface::RestructuredWorkHistory::WorkBreakComponent do
  ...
  it 'renders the component with the break length, reason and dates' do
    result = render_inline(CandidateInterface::RestructuredWorkHistory::WorkBreakComponent.new(work_break: work_break))
  ...
  context 'when not editable' do
    it 'renders the component without a delete link' do
      result = render_inline(CandidateInterface::RestructuredWorkHistory::WorkBreakComponent.new(work_break: work_break, editable: false))
