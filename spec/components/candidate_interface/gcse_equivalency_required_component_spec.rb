...
RSpec.describe CandidateInterface::GcseEquivalencyRequiredComponent, type: :component do
  ...
  let(:course_option1) { create(:course_option, course: create(:course, :open, accept_gcse_equivalency: true, accept_english_gcse_equivalency: true, accept_maths_gcse_equivalency: true, accept_science_gcse_equivalency: true)) }
  let(:course_option2) { create(:course_option, course: create(:course, :open, accept_gcse_equivalency: false, accept_english_gcse_equivalency: false, accept_maths_gcse_equivalency: false, accept_science_gcse_equivalency: false)) }
  let(:course_option3) { create(:course_option, course: create(:course, :open, accept_gcse_equivalency: true, accept_english_gcse_equivalency: false, accept_maths_gcse_equivalency: true, accept_science_gcse_equivalency: false)) }
