...
RSpec.describe CandidateInterface::ReferencesReviewComponent, type: :component do
  ...
  context 'when on application review page' do
    ...
    let(:component) do
      described_class.new(
        ...
        reference_process: 'candidate-details',
      )
    end
  ...
  context 'when on review page' do
    ...
    it 'renders all references passed in' do
      ...
      result = render_inline(
        described_class.new(
          references: [reference_one, reference_two],
          application_form:,
          reference_process: 'candidate-details',
        ),
      )
  ...
  def delete_reference_path(reference)
    Rails.application.routes.url_helpers.candidate_interface_confirm_destroy_new_reference_path('candidate-details', reference)
  end
end
