...
RSpec.describe ProviderInterface::FindCandidates::InviteLocationPreferencesComponent, type: :component do
  context 'specific locations' do
    it 'renders the locations' do
      ...
      expect(page).to have_element(:p, text: 'The candidate has said they can train:', class: 'govuk-hint')
