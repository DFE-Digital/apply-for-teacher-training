...
RSpec.feature 'Monthly statistics page' do
  ...
  def create_application_choices
    create(:completed_application_form, :with_rejection, course_option: create(:course_option, course: create(:course, level: 'primary', subjects: [create(:subject, name: 'Primary')])))
    create(:completed_application_form, :with_offer, course_option: create(:course_option, course: create(:course, level: 'secondary')))
    create(:completed_application_form, :with_offer, course_option: create(:course_option, course: create(:course, level: 'further_education')))
  end
