...
RSpec.describe 'Candidate account' do
  ...
  scenario 'Candidate signs in from the Account page with and without OneLogin setup' do
    ...
    when_i_choose_i_need_to_create_an_account
    and_i_click_continue
    then_i_am_on_the_sign_up_page
