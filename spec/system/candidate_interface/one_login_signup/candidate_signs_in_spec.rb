...
RSpec.describe 'Candidate signs in' do
  ...
  scenario 'Candidate signs in and signs out' do
    ...
    the_one_login_feature_flag_is_active
    ...
    then_a_request_to_one_login_is_triggered_to_sign_me_out
  ...
  def the_one_login_feature_flag_is_active
  ...
  def then_a_request_to_one_login_is_triggered_to_sign_me_out
    expect(page).to have_current_path(
      '/auth/onelogin/logout?id_token_hint=id_token',
    )
  end
end
