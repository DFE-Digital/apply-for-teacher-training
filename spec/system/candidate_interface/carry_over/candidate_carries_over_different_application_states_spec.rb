...
RSpec.feature 'Carry over application to a new cycle in different states', time: CycleTimetableHelper.mid_cycle(2024) do
  ...
  def then_i_should_be_on_the_pages_that_is_possible_to_carry_over_an_application
  ...
  def then_my_application_should_be_into_the_new_cycle
  ...
  def and_i_should_be_in_your_details_page
