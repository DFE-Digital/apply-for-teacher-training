...
RSpec.describe 'Candidate enters their english proficiency as none of these' do
  ...
  scenario 'with no details' do
    ...
    and_i_see_that_my_level_of_english_is_none_of_these_with_no_details
...
private
  ...
  def when_i_select_none_of_these
    check 'None of these'
  end
  ...
  def and_i_see_none_of_these_selected
    expect(page).to have_checked_field('None of these', type: 'checkbox')
  end
