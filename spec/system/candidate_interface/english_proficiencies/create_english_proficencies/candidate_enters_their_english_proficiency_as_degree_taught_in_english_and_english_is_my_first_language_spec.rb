...
RSpec.describe 'Candidate enters their english proficiency as degree taught in English and English is my first language' do
  ...
  scenario 'with no details' do
    ...
    and_i_see_that_my_level_of_english_is_degree_taught_in_english_and_english_is_my_first_language_with_no_details
  ...
  scenario 'with details' do
    ...
    then_i_see_the_review_page
    and_i_see_that_my_level_of_english_is_degree_taught_in_english_and_english_is_my_first_language_with_details
...
private
  ...
  def and_i_see_that_my_level_of_english_is_degree_taught_in_english_and_english_is_my_first_language_with_no_details
  ...
  def and_i_see_that_my_level_of_english_is_degree_taught_in_english_and_english_is_my_first_language_with_details
    within('.govuk-summary-card') do
      expect(page).to have_element(:h2, text: 'English as a foreign language assessment', class: 'govuk-summary-card__title')
      expect(page).to have_element(:dt, text: 'Proving your level of English', class: 'govuk-summary-list__key')
      expect(page).to have_element(:dd, text: 'English is my first language My degree was taught in English', class: 'govuk-summary-list__value')
