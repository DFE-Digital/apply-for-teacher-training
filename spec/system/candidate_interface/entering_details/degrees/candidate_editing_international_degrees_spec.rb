...
RSpec.describe 'Editing a degree' do
  ...
  def when_i_fill_in_the_type_of_degree
    fill_in 'candidate_interface_degree_form[international_type]', with: 'Diplôme'
  end
  ...
  def and_i_update_the_international_degrees_degree_type
    fill_in 'candidate_interface_degree_form[international_type]', with: 'Bachelor degree'
  end
