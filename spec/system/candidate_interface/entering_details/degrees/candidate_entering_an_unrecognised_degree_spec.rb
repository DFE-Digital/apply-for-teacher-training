...
RSpec.describe 'Entering a degree', :js, :with_cache do
  ...
  scenario 'Candidate enters their unrecognised degree' do
    ...
    when_i_fill_an_unrecognised_subject
    and_i_click_on_save_and_continue

    # Add subject areas
    then_i_can_see_the_subject_area_page
    when_i_select_art_and_design
    and_i_select_design_and_technology
    and_i_click_on_save_and_continue
...
private
  ...
  def when_i_fill_an_unrecognised_subject
    fill_in 'candidate_interface_degree_form[subject_raw]', with: 'Sausage making'
  ...
  def then_i_can_check_my_undergraduate_degree
    ...
    expect(page).to have_text 'Sausage making'
  ...
  def when_i_select_art_and_design
    check 'Art and design'
  end

  def and_i_select_design_and_technology
    check 'Design and technology'
  end
