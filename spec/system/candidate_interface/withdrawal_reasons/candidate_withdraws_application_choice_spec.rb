...
RSpec.describe 'Candidate selects secondary withdrawal reasons' do
  ...
  scenario 'Candidate sees error messages unless all required data has been entered' do
    ...
    when_i_select_the_primary_reason('I am going to apply (or have applied) to a different training provider')
  ...
  scenario 'Candidate selects all secondary reasons and withdraws' do
    given_i_have_submitted_an_application
    and_i_am_signed_in
    when_i_view_the_application
    and_i_click_on('withdraw this application')
    when_i_select_the_primary_reason('I am going to apply (or have applied) to a different training provider')
    and_i_select_all_the_secondary_reasons
  ...
  def when_i_enter_details_for_personal_circumstances_other_option(error: false)
    id = 'candidate-interface-withdrawal-reasons-secondary-reasons-form-personal-circumstances-reasons-comment-field'
    id += '-error' if error
  ...
  def and_i_select_all_the_secondary_reasons
    [
