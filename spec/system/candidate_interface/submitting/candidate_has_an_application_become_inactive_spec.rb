...
RSpec.describe 'Candidate with submitted applications' do
  ...
  def then_i_can_add_another_application
    expect(page).to have_text("You can create 1 more application for courses starting in the #{current_candidate.current_application.academic_year_range_name} academic year.")
  end
