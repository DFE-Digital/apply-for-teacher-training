...
RSpec.describe 'See an application' do
  ...
  it 'Support agent visits application page' do
    ...
    then_i_will_be_on_the_application_view_page
    and_i_will_see_a_summary_of_the_completed_application
    and_i_will_see_their_referees

    when_i_return_to_the_support_page
    and_i_click_on_an_unsubmitted_application
    then_i_will_see_a_summary_of_the_unsubmitted_application

    when_i_return_to_the_support_page
    and_i_click_on_an_application_with_a_reference
    then_i_will_see_the_reference_from_first_referee
    and_i_will_not_see_reference_from_second_referee
  end
  ...
  def and_i_will_see_their_referees
