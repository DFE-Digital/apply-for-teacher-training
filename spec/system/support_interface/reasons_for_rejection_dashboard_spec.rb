...
private
  ...
  def then_i_should_see_reasons_for_rejection_course_full
    ...
    expect(all('.govuk-grid-row')[0]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_candidate_behaviour
    ...
    expect(all('.govuk-grid-row')[2]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_honesty_and_professionalism
    ...
    expect(all('.govuk-grid-row')[4]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_offered_on_another_course
    ...
    expect(all('.govuk-grid-row')[6]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_performance_at_interview
    ...
    expect(all('.govuk-grid-row')[8]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_qualifications
    ...
    expect(all('.govuk-grid-row')[10]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_quality_of_application
    ...
    expect(all('.govuk-grid-row')[12]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_safeguarding_concerns
    ...
    expect(all('.govuk-grid-row')[14]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_interested_in_future_applications
    ...
    expect(all('.govuk-grid-row')[16]).to have_content('10% Overall percentage')
  ...
  def and_i_should_see_reasons_for_rejection_other_advice_or_feeback
    ...
    expect(all('.govuk-grid-row')[18]).to have_content('10% Overall percentage')
