...
private
  ...
  def and_an_emails_has_been_dispatched
    @bob_email = create(:email, to: 'bob@example.com', subject: 'Hello Bob', body: 'Welcome to Apply Bob')
    @jane_email = create(:email, to: 'jane@example.com', subject: 'Hello Jane', body: 'Jane, your application has been accepted')
  end
