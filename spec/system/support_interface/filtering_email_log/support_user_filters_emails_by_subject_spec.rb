...
private
  ...
  def and_an_emails_has_been_dispatched
    ...
    @bob_email = create(:email, to: 'bob@example.com', subject: 'Hello Bob', application_form: @application_form)
    @jane_email = create(:email, to: 'jane@example.com', subject: 'Hello Jane', application_form: @application_form)
  end
