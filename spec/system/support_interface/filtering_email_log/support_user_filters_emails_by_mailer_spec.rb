...
RSpec.describe 'Support user filters emails by mailer' do
  ...
  def then_i_see_an_email_for_bob
    within('.govuk-table') do
      ...
      expect(page).to have_element(:dd, text: '(Support mailer)')
  ...
  def and_i_see_an_email_for_harry
    within('.govuk-table') do
      ...
      expect(page).to have_element(:dd, text: '(Candidate mailer)')
      expect(page).to have_element(:dt, text: 'To')
  ...
  def and_i_do_not_see_an_email_for_jane
    within('.govuk-table') do
      ...
      expect(page).not_to have_element(:dd, text: '(Referee mailer)')
    end
  end
end
