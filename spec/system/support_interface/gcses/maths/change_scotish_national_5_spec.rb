...
RSpec.describe 'Change maths GCSE' do
  ...
  scenario 'Change the maths Scotish National 5 on an application form', :with_audited do
    given_i_am_a_support_user
    and_there_is_an_application_choice_awaiting_provider_decision

    when_i_visit_the_application_page
    and_i_click_to_change_the_maths_scotish_national_5
    then_i_see_the_form_to_change_the_applications_maths_scotish_national_5
    ...
    and_the_maths_o_level_has_been_updated
  end
...
private
  ...
  def and_i_click_to_change_the_maths_scotish_national_5
    within('.app-edit-qualification') do
      click_link_or_button 'Change'
    end
  end

  def then_i_see_the_form_to_change_the_applications_maths_scotish_national_5
  ...
  def and_the_maths_o_level_has_been_updated
    expect(page).to have_element(:h4, text: 'Maths Scottish National 5')
