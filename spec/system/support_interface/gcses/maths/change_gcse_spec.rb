...
RSpec.describe 'Change maths GCSE' do
  ...
  scenario 'Change the maths GCSE on an application form', :with_audited do
    ...
    then_i_see_the_form_to_change_the_applications_maths_gcse
  ...
  def then_i_see_the_form_to_change_the_applications_maths_gcse
  ...
  def and_the_english_o_level_has_been_updated
    expect(page).to have_element(:h4, text: 'Maths GCSE')
