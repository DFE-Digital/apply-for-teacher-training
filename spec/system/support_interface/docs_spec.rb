...
RSpec.feature 'Docs' do
  ...
  def and_it_contains_documentation_for_all_emails
    emails_outside_of_states = %w[
      ...
      candidate_mailer-application_rejected__one_offer_one_awaiting_decision
      candidate_mailer-application_rejected__awaiting_decision_only
      candidate_mailer-application_rejected__offers_only
    ]
