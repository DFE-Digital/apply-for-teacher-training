...
RSpec.describe 'Change volunteering role' do
  ...
  def then_i_see_validation_errors
    expect(page).to have_text('Enter your role')
    expect(page).to have_text('Enter the organisation where you gained experience or volunteered')
  end
  ...
  def then_i_see_the_success_message
    expect(page).to have_text('Volunteering role updated')
  end
