...
RSpec.describe 'Change offer conditions' do
  ...
  scenario 'Provider user changes the conditions on an offer with javascript on', :js, :with_cache do
  ...
  scenario 'Provider user changes the conditions on an offer with javascript off', :with_cache, js: false do
    given_i_am_a_provider_user_with_dfe_sign_in
    and_i_am_an_authorised_provider_user
    and_i_can_access_the_provider_interface
