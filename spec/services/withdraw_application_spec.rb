...
RSpec.describe WithdrawApplication do
  ...
  context 'when accepted_offer is false by default' do
    it 'sends the manual withdrawal notification email to the training provider and ratifying provider' do
  ...
  context 'when accepted_offer is true' do
    ...
    it 'sends the automatic withdrawal email to the training provider and ratifying provider' do
