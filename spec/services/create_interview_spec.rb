...
RSpec.describe CreateInterview do
  ...
  describe '#save!' do
    ...
    it 'creates an audit entry', with_audited: true do
      ...
      expect(associated_audit.audited_changes.keys).to contain_exactly(*%w[
        location provider_id date_and_time additional_details application_choice_id cancellation_reason cancelled_at
      ])
