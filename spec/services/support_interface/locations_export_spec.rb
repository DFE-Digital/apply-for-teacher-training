...
RSpec.describe SupportInterface::LocationsExport do
  describe '#data_for_export' do
    ...
    it 'returns a hash of location and application choice related data' do
      ...
      create(:degree_qualification, award_year: '2020', application_form: application_form)
...
private
  ...
  def expected_hash(application_choice)
    {
      'id' => application_choice.application_form.candidate.id,
      'Age' => 20,
      'Candidates postcode' => application_choice.application_form.postcode,
