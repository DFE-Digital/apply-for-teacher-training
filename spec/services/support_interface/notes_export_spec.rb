...
RSpec.describe SupportInterface::NotesExport do
  ...
  describe 'data_for_export' do
    it 'returns a hash of notes data' do
      ...
      application_choice1 = create(:application_choice, candidate: candidate, current_course_option: course_option)
      application_choice2 = create(:application_choice, candidate: candidate, current_course_option: course_option)
