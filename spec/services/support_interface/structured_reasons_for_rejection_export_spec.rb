    ...
    it 'returns an array of hashes containing structured reasons for rejection data' do
      ...
      expect(described_class.new.data_for_export).to eq(
        [{
          ...
          'Recruitment cycle year' => application_choice_one.course.recruitment_cycle_year,
          'Phase (apply1/apply2)' => application_choice_one.application_form.phase,
          'Provider code' => application_choice_one.provider.code,
          'Course code' => application_choice_one.course.code,
          'Date rejected' => application_choice_one.rejected_at.strftime('%d/%m/%Y'),
          ...
          'Offered on another course - details' => application_choice_one.structured_rejection_reasons['offered_on_another_course_details'],
        ...
        },
         {
           ...
           'Recruitment cycle year' => application_choice_two.course.recruitment_cycle_year,
           'Phase (apply1/apply2)' => application_choice_two.application_form.phase,
           'Provider code' => application_choice_two.provider.code,
           'Course code' => application_choice_two.course.code,
           'Date rejected' => application_choice_two.rejected_at.strftime('%d/%m/%Y'),
           'Something you did' => nil,
           ...
           'Performance at interview' => nil,
           'Performance at interview - what to improve' => nil,
           'Course full' => nil,
           'They offered you a place on another course' => nil,
           'Offered on another course - details' => nil,
           'Honesty and professionalism' => nil,
