...
RSpec.describe SupportInterface::MonthlyStatisticsExports::ApplicationsByPrimarySpecialistSubjectExport do
  describe '#data_for_export' do
    ...
    before do
      monthly_statistics_double = instance_double(Publications::MonthlyStatistics::ByPrimarySpecialistSubject)
      allow(Publications::MonthlyStatistics::ByPrimarySpecialistSubject).to receive(:new).and_return monthly_statistics_double
