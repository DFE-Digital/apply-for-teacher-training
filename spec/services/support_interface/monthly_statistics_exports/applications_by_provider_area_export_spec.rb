...
RSpec.describe SupportInterface::MonthlyStatisticsExports::ApplicationsByProviderAreaExport do
  describe '#data_for_export' do
    ...
    before do
      monthly_statistics_double = instance_double(MonthlyStatistics::ByProviderArea)
      allow(MonthlyStatistics::ByProviderArea).to receive(:new).and_return monthly_statistics_double
