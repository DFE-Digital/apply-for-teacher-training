...
RSpec.describe SupportInterface::MonthlyStatisticsExports::ApplicationsByCourseTypeExport do
  describe '#data_for_export' do
    ...
    before do
      monthly_statistics_double = instance_double(Publications::MonthlyStatistics::ByCourseType)
      allow(Publications::MonthlyStatistics::ByCourseType).to receive(:new).and_return monthly_statistics_double
