...
RSpec.describe CandidateInterface::WithdrawalReasons::LevelTwoReasonsBuilder do
  describe '#form_attributes' do
    ...
    context 'when no draft withdrawal reasons exist' do
      it 'returns empty / nil values for all attributes other than level_one_rason' do
        ...
        expect(builder.form_attributes).to eq(
          {
            ...
            personal_circumstances_reasons: %w[personal-circumstances-have-changed.other personal-circumstances-have-changed.concerns-about-cost-of-doing-course],
            comment: nil,
