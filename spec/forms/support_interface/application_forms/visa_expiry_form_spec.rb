...
module SupportInterface
  RSpec.describe ApplicationForms::VisaExpiryForm, type: :model do
    subject(:form) do
    ...
    describe '#save' do
      it 'saves visa_expred_at on application_form', :with_audited do
        ...
        expect(application_form.audits.last.comment).to eq('comment')
      end
