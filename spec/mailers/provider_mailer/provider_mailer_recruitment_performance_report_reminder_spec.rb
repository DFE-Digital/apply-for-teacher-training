...
RSpec.describe ProviderMailer do
  describe 'recruitment_performance_report_reminder' do
    ...
    it_behaves_like(
      ...
      'give feedback' => 'We’d love to hear your thoughts so we can make the report as useful as possible. If you’d like to share feedback or take part in user research, please complete',
