...
RSpec.describe ProviderMailer do
  ...
  describe '.application_submitted' do
    let(:email) { described_class.application_submitted(provider_user, application_choices.first) }
    ...
    context 'when a candidate submits an application' do
      it_behaves_like('a mail with subject and content',
                      ...
                      'link to applications' => /http:\/\/localhost:3000\/provider\/applications\/\d+/,
