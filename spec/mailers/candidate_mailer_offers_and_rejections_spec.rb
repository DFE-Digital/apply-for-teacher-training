...
RSpec.describe CandidateMailer do
  ...
  let(:offer) { build_stubbed(:offer, conditions: [build_stubbed(:text_condition, text: 'Be cool')]) }
  let(:other_offer) { build_stubbed(:offer, conditions: [build_stubbed(:text_condition, text: 'Be even cooler')]) }
  ...
  describe '.reinstated_offer' do
    ...
    describe 'with pending conditions' do
      before do
        allow(application_choice.offer).to receive(:conditions)
          .and_return([build_stubbed(:text_condition, status: :pending, text: 'GCSE Maths grade 4 (C) or above, or equivalent')])
      end
    ...
    describe 'with met conditions' do
      before do
        allow(application_choice.offer).to receive(:conditions)
          .and_return([build_stubbed(:text_condition, status: :met, text: 'GCSE Maths grade 4 (C) or above, or equivalent')])
      end
  ...
  describe '.conditions_not_met' do
    ...
    let(:application_choice) do
      build_stubbed(:application_choice, :conditions_not_met,
                    ...
                    offer: build_stubbed(:offer, conditions: [build_stubbed(:text_condition, :unmet, text: 'Be cool')]),
