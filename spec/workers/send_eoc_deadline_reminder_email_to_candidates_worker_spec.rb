...
RSpec.describe SendEocDeadlineReminderEmailToCandidatesWorker, :sidekiq do
  describe '#perform' do
    ...
    it 'returns an application for the second reminder ate away' do
      second_reminder_date = EndOfCycle::CandidateEmailTimetabler.new.apply_deadline_second_reminder_date
  ...
  def first_reminder_date
    @first_reminder_date ||= EndOfCycle::CandidateEmailTimetabler.new.apply_deadline_first_reminder_date
  end
end
