...
RSpec.describe SendFindHasOpenedEmailToCandidatesWorker, sidekiq: true do
  ...
  describe 'Staggered email sending' do
    ...
    before do
      ...
      allow(SendFindHasOpenedEmailToCandidatesBatchWorker).to receive(:perform_at).and_return(nil)
    end
    ...
    context 'with a single batch' do
      ...
      it 'queues one unstaggered SendFindHasOpenedEmailToCandidatesBatchWorker job' do
        described_class.new.perform
    ...
    context 'with 2 batches' do
      ...
      it 'queues two staggered SendFindHasOpenedEmailToCandidatesBatchWorker jobs' do
        described_class.new.perform
