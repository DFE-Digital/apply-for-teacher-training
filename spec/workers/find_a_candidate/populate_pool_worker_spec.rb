...
RSpec.describe FindACandidate::PopulatePoolWorker do
  describe '#perform' do
    ...
    context 'with fee_funding_type' do
      it 'sets fee_funding_type true when open to fee funding courses' do
        ...
        candidate_pool_application = CandidatePoolApplication.last
        expect(candidate_pool_application.fee_funding_type).to be true
      end

      it 'sets fee_funding_type true when open to fee funding courses but applied to salary' do
        unrelated_form = create(:application_form, :completed)
        create(
          :application_choice,
          application_form: unrelated_form,
      ...
      it 'sets fee_funding_type true when applied to fee funded courses but no preference' do
        unrelated_form = create(:application_form, :completed)
        create(
          :application_choice,
          application_form: unrelated_form,
      ...
      it 'sets fee_funding_type false when preference is only salary' do
        unrelated_form = create(:application_form, :completed)
        create(
          :application_choice,
          application_form: unrelated_form,
        ...
        candidate_pool_application = CandidatePoolApplication.last
        expect(candidate_pool_application.fee_funding_type).to be false
      end

      it 'sets fee_funding_type false when no preference but only applied to salary courses' do
        unrelated_form = create(:application_form, :completed)
        create(
          :application_choice,
          application_form: unrelated_form,
