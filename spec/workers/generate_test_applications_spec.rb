...
RSpec.describe GenerateTestApplications do
  ...
  it 'generates test candidates with applications in various states', time: mid_cycle do
  ...
  it 'generates undergraduate test applications', time: mid_cycle do
    current_cycle = current_year
    previous_cycle = previous_year
  ...
  it 'generates test applications for the next cycle', time: mid_cycle do
    current_cycle = current_year
    provider = create(:provider)
