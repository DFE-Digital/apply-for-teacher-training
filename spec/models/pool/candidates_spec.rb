  ...
  describe '.application_forms_for_provider' do
    context 'tests base query without filters' do
      it 'returns application_forms that should be on candidate pool list' do
        ...
        create(:pool_eligible_application_form, application_form: withdrawn_candidate_form)
        ...
        create(:pool_eligible_application_form, application_form: conditions_not_met_candidate_form)
        ...
        create(:pool_eligible_application_form, application_form: offer_withdrawn_candidate_form)
        ...
        create(:pool_eligible_application_form, application_form: inactive_candidate_form)
      ...
      it 'does not returns application_forms that should not be on the candidate pool list' do
        ...
        create(:pool_eligible_application_form, application_form: dismissed_candidate_form)
        ...
        create(:pool_eligible_application_form, application_form: candidate_with_too_many_choices_form)
    ...
    def create_manchester_candidate_form(provider)
      ...
      create(:pool_eligible_application_form, application_form: manchester_candidate_form)
      course = create(:course, provider:)
      course_option = create(
        :course_option,
        course: course,
    ...
    def create_subject_candidate_form(course_option)
      ...
      create(:pool_eligible_application_form, application_form: subject_candidate_form)
    ...
    def create_part_time_candidate_form(course_option)
      ...
      create(:pool_eligible_application_form, application_form: part_time_candidate_form)
    ...
    def create_undergraduate_candidate_form(course_option)
      ...
      create(:pool_eligible_application_form, application_form: undergraduate_candidate_form)
    ...
    def create_visa_sponsorship_candidate_form(course_option)
      ...
      create(:pool_eligible_application_form, application_form: visa_sponsorship_candidate_form)
