module CandidateHelper
  ...
  def given_courses_exist
    ...
    course =
      Course.find_by(code: '2XT2', provider: @provider, recruitment_cycle_year:) ||
      create(:course, :open, name: 'Primary', code: '2XT2', provider: @provider, recruitment_cycle_year:, start_date: Date.new(recruitment_cycle_year, 9, 1), level: :primary, degree_grade: 'two_two')
    course2 =
      Course.find_by(code: '2397', provider: @provider, recruitment_cycle_year:) ||
      create(:course, :open, name: 'Drama', level: 'secondary', code: '2397', provider: @provider, recruitment_cycle_year:, start_date: Date.new(recruitment_cycle_year, 9, 1), degree_grade: 'two_two')
    course3 =
      Course.find_by(code: '6Z9H', provider: @provider, recruitment_cycle_year:) ||
      create(:course, :open, name: 'English', level: 'secondary', code: '6Z9H', provider: @provider, recruitment_cycle_year:, start_date: Date.new(recruitment_cycle_year, 9, 1), degree_grade: 'two_two')
    course4 =
      Course.find_by(code: '2392', provider: @provider, recruitment_cycle_year:) ||
      create(:course, :open, name: 'Biology', level: 'secondary', code: '2392', provider: @provider, recruitment_cycle_year:, start_date: Date.new(recruitment_cycle_year, 9, 1), degree_grade: 'two_two')
    course5 =
      Course.find_by(code: 'C998', provider: @provider, recruitment_cycle_year:) ||
      create(:course, :teacher_degree_apprenticeship, :open, name: 'Mathematics (SEND)', level: 'primary', code: 'C998', provider: @provider, recruitment_cycle_year:, start_date: Date.new(recruitment_cycle_year, 9, 1), degree_grade: 'two_two')
  ...
  def current_candidate
    if !Candidate.exists?(@current_candidate&.id)
