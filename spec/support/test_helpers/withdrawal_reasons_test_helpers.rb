module WithdrawalReasonsTestHelpers
  ...
  def when_i_select_the_primary_reason(primary_reason)
    choose primary_reason
    click_on 'Continue'
  end
  ...
  def when_i_enter_details_for_main_other_option(error: false)
    id = 'candidate-interface-withdrawal-reasons-secondary-reasons-form-comment-field'
    id += '-error' if error
