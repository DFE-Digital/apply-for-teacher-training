...
variable "postgres_replica_sku" { default = "B_Standard_B1ms" }
variable "postgres_flexible_server_storage_mb" { default = 32768 }
variable "postgres_replica_storage_mb" { default = 32768 }
variable "postgres_enable_high_availability" { default = false }
variable "replica_enable_high_availability" { default = false }
variable "postgres_server_version" { default = "16" }
variable "postgres_replica_version" { default = "16" }
