class FlatReasonsForRejectionPresenter
  ...
  attr_accessor :structured_rejection_reasons_hash, :candidate_behaviour, :didnt_reply_to_interview_offer, :didnt_attend_interview,
                :candidate_behaviour_other_details, :candidate_behaviour_what_to_improve_details, :quality_of_application, :personal_statement,
                :quality_of_application_personal_statement_what_to_improve, :subject_knowledge, :quality_of_application_subject_knowledge_what_to_improve_details,
                :quality_of_application_other_what_to_improve_details, :quality_of_application_other_details, :qualifications, :no_maths_gcse,
                :no_english_gcse, :no_science_gcse, :no_degree, :qualifications_other_details, :performance_at_interview,
                :performance_at_interview_what_to_improve_details, :course_full, :offered_on_another_course, :honesty_and_professionalism,
                :information_false_or_inaccurate, :honesty_and_professionalism_concerns_information_false_or_inaccurate_details,
                :plagiarism, :honesty_and_professionalism_concerns_plagiarism_details, :references, :honesty_and_professionalism_concerns_references_details,
                :honesty_and_professionalism_concerns_other_details, :safeguarding, :candidate_disclosed_information,
