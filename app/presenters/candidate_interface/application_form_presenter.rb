  ...
  class ApplicationFormPresenter
    ...
    def degrees_path
      if degrees_completed? || degrees_added?
        ...
        FeatureFlag.active?(:new_degree_flow) ? Rails.application.routes.url_helpers.candidate_interface_degrees_review_path : Rails.application.routes.url_helpers.candidate_interface_new_degree_path
      end
    end
