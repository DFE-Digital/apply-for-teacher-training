class ApplicationChoice < ApplicationRecord
  ...
  def update_course_option_and_associated_fields!(new_course_option, other_fields: {}, audit_comment: nil)
    ...
    attrs[:personal_statement] = application_form.becoming_a_teacher if self.personal_statement.blank?
    ...
    ActiveRecord::Base.transaction do
      ...
      CandidateInterface::InviteApplication.accepted!(application_choice: self)
      true
    end
  end
