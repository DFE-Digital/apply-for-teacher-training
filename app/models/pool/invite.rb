class Pool::Invite < ApplicationRecord
  ...
  has_many :pool_invite_chasers_sent, -> { where(chaser_type: 'pool_invite') }, class_name: 'ChaserSent', as: :chased, dependent: :destroy
  has_many :initial_pool_invite_chasers_sent, -> { where(chaser_type: 'initial_pool_invite') }, class_name: 'ChaserSent', as: :chased, dependent: :destroy
