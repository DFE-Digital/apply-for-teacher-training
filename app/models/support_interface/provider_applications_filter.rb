module SupportInterface
  class ProviderApplicationsFilter
    ...
    def filter_records(application_forms)
      ...
      application_forms = apply_training_provider_filter(application_forms) if applied_filters[:training_provider].present?
      application_forms = apply_accrediting_provider_filter(application_forms) if applied_filters[:accredited_provider].present?
