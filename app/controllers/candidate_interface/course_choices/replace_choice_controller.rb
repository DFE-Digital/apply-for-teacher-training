  ...
  module CourseChoices
    class ReplaceChoiceController < BaseController
      ...
      def validate_location
        @course_choice = current_application.application_choices.find(params['id'])
        @new_course_option_id = params.dig('candidate_interface_pick_site_form', 'course_option_id')
        ...
        @pick_site = PickSiteForm.new(
          ...
          course_id: @course_choice.course.id,
          study_mode: @course_choice.course_option.study_mode,
          course_option_id: @new_course_option_id,
        )

        if @pick_site.valid?
          redirect_to candidate_interface_confirm_replacement_course_choice_path(@course_choice.id, @new_course_option_id)
        else
