module CandidateInterface
  module WithdrawalReasons
    class LevelOneReasonsController < WithdrawalsController
      before_action :set_draft_reason, only: %i[review edit continue]
      before_action :clear_earlier_drafts, only: %i[review]
      ...
      def continue
        ...
        if @level_one_reasons_form.invalid?
          ...
          redirect_to candidate_interface_withdrawal_reasons_level_one_reason_review_path(
            withdrawal_reason_id: draft_withdrawal_reason.id,
          )
        else
          redirect_to candidate_interface_withdrawal_reasons_level_two_reasons_start_path(
