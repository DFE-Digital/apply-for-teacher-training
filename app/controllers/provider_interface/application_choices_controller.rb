  ...
  class ApplicationChoicesController < ProviderInterfaceController
    ...
    def index
      @filter = ProviderApplicationsFilter.new(
        ...
        state_store: StateStores::RailsCacheStore.new(key: state_store_key),
      )
    ...
    def application_withdrawable?
      @provider_user_can_make_decisions && !@application_choice.application_unsuccessful_without_inactive?
    end
