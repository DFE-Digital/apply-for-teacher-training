module RegisterAPI
  ...
  private
    ...
    def recruitment_cycle_year_param
      ...
      valid_years = RecruitmentCycleTimetable.pluck(:recruitment_cycle_year).reject { |cycle_year| cycle_year > RecruitmentCycleTimetable.current_year }.map(&:to_s)
      raise ParameterInvalid, 'Parameter is invalid: recruitment_cycle_year' unless year.in?(valid_years)
