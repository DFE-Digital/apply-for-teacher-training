  ...
  private
    ...
    def vendor_api_row
      if visible_over_vendor_api?
        application_json = AllowedCrossNamespaceUsage::VendorAPIApplicationPresenter.new(AllowedCrossNamespaceUsage::VendorAPIInfo.production_version, application_choice).as_json
        {
          key: 'Vendor API',
