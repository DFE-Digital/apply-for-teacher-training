module ProviderInterface
  class ApplicationRejectionFeedbackComponent < ApplicationComponent
      ...
      if application_choice.rejected_by_default
        rows = [
          {
            ...
            value: application_choice.rejected_at.to_fs(:govuk_date),
          },
        ]
        if application_choice.reject_by_default_feedback_sent_at.present?
          rows + [
            {
              key: 'Feedback sent',
              value: application_choice.reject_by_default_feedback_sent_at.to_fs(:govuk_date),
            },
            {
