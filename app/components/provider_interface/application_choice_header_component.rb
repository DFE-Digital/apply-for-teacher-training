module ProviderInterface
  class ApplicationChoiceHeaderComponent < ViewComponent::Base
    ...
    def sub_navigation_items
      ...
      sub_navigation_items.push(references_navigation_item) if FeatureFlag.active?(:new_references_flow_providers) && !application_choice.status.to_sym.in?(ApplicationStateChange::UNSUCCESSFUL_END_STATES)
