module CandidateInterface
  ...
  private
    ...
    def conditions_row
      {
        key: 'Conditions',
        value: render(OfferConditionsReviewComponent.new(conditions: @course_choice.offer.non_ske_conditions_text, provider: @course_choice.current_course.provider.name, application_form: @course_choice.application_form)),
      }
    end
