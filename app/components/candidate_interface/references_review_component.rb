module CandidateInterface
  class ReferencesReviewComponent < ViewComponent::Base
    ...
    def initialize(application_form:, references:, application_choice: nil, editable: true, heading_level: 2, return_to_application_review: false, missing_error: false, deletable: true, reference_process:)
