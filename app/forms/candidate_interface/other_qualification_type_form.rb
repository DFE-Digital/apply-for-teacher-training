module CandidateInterface
  class OtherQualificationTypeForm
    ...
    attr_reader :persistence_key_for_current_user, :next_step
    ...
    def initialize(persistence_key_for_current_user, options)
      @persistence_key_for_current_user = persistence_key_for_current_user
      super(options)
    end
