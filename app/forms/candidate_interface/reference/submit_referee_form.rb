module CandidateInterface
  ...
  private
    ...
    def all_details_provided?
      ...
      return true if CandidateInterface::References::TypeStep.new(referee_type: reference.referee_type).valid? &&
                     CandidateInterface::References::NameStep.new(name: reference.name, referee_type: reference.referee_type).valid? &&
                     email_step(reference).valid? &&
                     CandidateInterface::References::RelationshipStep.new(relationship: reference.relationship).valid?
