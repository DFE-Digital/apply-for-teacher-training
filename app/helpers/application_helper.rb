module ApplicationHelper
  ...
  def start_date_to_date_object(params)
    day = params.fetch('start_date(3i)').to_i
    month = params.fetch('start_date(2i)').to_i
    year = params.fetch('start_date(1i)').to_i

    Date.new(year, month, day)
  end

  def end_date_to_date_object(params)
    day = params.fetch('end_date(3i)').to_i
    month = params.fetch('end_date(2i)').to_i
    year = params.fetch('end_date(1i)').to_i
