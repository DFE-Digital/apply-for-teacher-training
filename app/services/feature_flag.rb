class FeatureFlag
  ...
  TEMPORARY_FEATURE_FLAGS = [
    ...
    [:one_login_pre_release_banners, 'Show banners related to One Login release', 'Lori Bailey'],
    [:use_database_backed_real_cycle_dates, 'Uses database backed cycle dates for production, not the cycle switcher', 'Lori Bailey'],
  ].freeze
