class FeatureFlag
  ...
  TEMPORARY_FEATURE_FLAGS = [
    ...
    [:incident_eviction, "Evicting potential ghost users from affected candidate accounts, deploy_date: #{ENV.fetch('INCIDENT_240306_FIX_DEPLOYMENT_TIME', Time.zone.local(2024, 3, 11, 14).to_fs(:iso8601))}", 'Lori Bailey'],
  ].freeze
