    ...
    def data_for_export
      data_for_export = application_forms.includes(:application_choices).map do |application_form|
        ...
        output = {
          ...
          'Application choice 1 structured rejection reasons' => FlatReasonsForRejectionPresenter.build_high_level(rejected_application_choices[0]&.structured_rejection_reasons),
          'Application choice 2 structured rejection reasons' => FlatReasonsForRejectionPresenter.build_high_level(rejected_application_choices[1]&.structured_rejection_reasons),
          'Application choice 3 structured rejection reasons' => FlatReasonsForRejectionPresenter.build_high_level(rejected_application_choices[2]&.structured_rejection_reasons),
        }
