    ...
    def self.call(application_choices:)
      ...
      applications.each do |application_choice|
        ...
        rows << {
          ...
          'provider_code' => application.offered_provider.code,
          ...
          'course_code' => application.offered_course.code,
          'site_code' => application.offered_site.code,
          'study_mode' => application.offered_course.study_mode,
          'start_date' => application.offered_course.start_date,
