...
describe('cookie helper methods', () => {
  ...
  describe('setConsentedToCookie', () => {
    ...
    it('removes ms clarity cookies if a user rejected cookie', () => {
      const fakeEssentialCookies = ['taste', 'smell', 'sight']
      const fakeMSClarityCookies = [
        '_clck',
        '_clsk',
        'CLID',
        'ANONCHK',
      ...
      fakeMSClarityCookies.forEach(cookieName => {
        setCookie(cookieName, 1)
      })

      expect(fetchAllCookies().length).toEqual(10)
